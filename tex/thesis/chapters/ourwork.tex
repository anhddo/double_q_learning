...
To find the minimum of regret we take the derivative of Regret w.r.t  $ \gamma $ and set it to zero.
$$
\nabla _{ \gamma }\text{Regret(T)} = 0
$$
$$
\begin{aligned} 
    \nabla _{ \gamma }\text{Regret(T)} =& 
    O\left( - CT + \frac{ClogT}{\left( 1-  \gamma \right) ^{2}} - \frac{2C ^{'}}{\left( 1-  \gamma \right) ^{3}} + \frac{\sqrt{T}}{\left( 1-  \gamma \right) ^{2}}\right) =0\\
    \Rightarrow &   O\left((1- \gamma) ^{3} T - (1- \gamma) C \log T + 2 C' -  (1- \gamma) \sqrt{T}  \right) =0\\ 
\end{aligned}
$$
Let $x=1-  \gamma $ then we have: 
$$
\begin{aligned} 
    \Rightarrow &   O\left(x ^{3} T - x C \log T + 2 C' -  x \sqrt{T}  \right) =0\\ 
    \Rightarrow &   O\left(x ^{3} T -  (C \log T  -  \sqrt{T})x  \right) =0\\ 
    \Rightarrow &   O\left(x ^{3} T \right) = O \left( \sqrt{T}x\right)\\ 
    \Rightarrow &   x=O\left(T ^{-1/4} \right) \\ 
    \Rightarrow &    \gamma =O\left(1-T ^{-1/4} \right) \\ 
\end{aligned}
$$
